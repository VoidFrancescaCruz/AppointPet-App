...
function OnboardingStackScreen() {
  return (
    <NavigationContainer>
      <RootStack.Navigator
        // initialRouteName={navigationStrings.ONBOARDINGA}
        screenOptions={{
          headerShown: false,
        }}>
        <RootStack.Screen
          name={navigationStrings.ONBOARDINGA}
          component={OnboardingA}
        />
        <RootStack.Screen
          name={navigationStrings.ONBOARDINGB}
          component={OnboardingB}
        />
        <RootStack.Screen
          name={navigationStrings.ONBOARDINGC}
          component={OnboardingC}
        />
        <RootStack.Screen
          name={navigationStrings.ONBOARDINGD}
