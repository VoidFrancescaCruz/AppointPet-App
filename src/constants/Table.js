...
export default class Table extends React.Component {
  ...
  handlePress = () => {
    ...
    fetch('http://10.0.2.2/master3-april28/AppointPet-App/src/Screens/getPetName.php', {
      method: 'POST',
      headers: {
    ...
    fetch('http://10.0.2.2/master3-april28/AppointPet-App/src/Screens/getProfile.php', {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
      },
