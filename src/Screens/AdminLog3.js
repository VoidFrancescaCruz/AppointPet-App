...
export default class AdminLog extends Component {
  ...
  InsertRecord=()=>{
    ...
    if ((Email?.length === 0) || (Password?.length === 0)){
      ...
      var APIURL = 'http://10.0.2.2/master3-april28/AppointPet-App/src/Screens/AdminLog.php';
      ...
      console.log("adminUsername:", this.state.adminUsername);
      fetch(APIURL,{
