...
//THIS IS FOR FORGOT PASSWORD OF THE ADMIN-SIDE

export default class VerifyEmailAdmin extends Component {
  constructor(props) {
    super(props);
    this.state = {
      email: '',
  ...
  InsertRecord = () => {
    ...
    if (Email.length === 0 || Otp.length === 0) {
      ...
      var APIURL =
        'https://www.appointpet.infinityfreeapp.com/VerifyEmailAdminApp.php';
      ...
      fetch(APIURL, {
        ...
        .then((Response) => {
          alert(Response[0].Message);
            this.props.navigation.navigate('ChangePasswordAdmin');
        })
        .catch((error) => {
