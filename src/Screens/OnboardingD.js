...
export default class OnboardingD extends Component {
  ...
  onDonePressed = async () => {
    ...
    await AsyncStorage.setItem('Onboard', OnboardingComplete);
  };

  onBackPressed = () => {
    this.props.navigation.navigate(navigationStrings.ONBOARDINGC);
  };
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.margin1}>
          <TouchableOpacity style={styles.btn} onPress={this.onBackPressed}>
            <Text style={styles.btnText1}>BACK</Text>
          </TouchableOpacity>
          <Image source={imagePath.bulletsD} style={styles.bullet} />
          <TouchableOpacity style={styles.btn} onPress={this.onDonePressed}>
