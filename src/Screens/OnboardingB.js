...
const OnboardingB = () => {
  ...
  const onBackPressed = () => {
    navigation.navigate(navigationStrings.ONBOARDINGA);
  };
  return (
    <View style={styles.container}>
      ...
      <View style={styles.margin0}>
        <Text style={styles.header}>
          Decide which services suit your needs.
        </Text>
      </View>

      <View style={styles.margin}>
        <Image source={imagePath.onboardingB} style={styles.image}/>
      </View>
      ...
      <View style={styles.margin1}>
        ...
        <Image source={imagePath.bulletsB} style={styles.bullet}/>
