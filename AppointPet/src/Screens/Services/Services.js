    ...
    <ScrollView>
      <View name="Service1">
        ...
        <View style={[styles.container1, styles.secondary]}>
          <Text style={styles.header0}>Diagnosis and Therapeutic</Text>
          <Text style={styles.header1}>P 1, 499.00</Text>
          <Text style={[styles.descTxt, {color: colors.black}]}>
      ...
      <View name="Service2">
        ...
        <View style={[styles.container1, styles.secondary]}>
          <Text style={styles.header0}>Surgical</Text>
          <Text style={styles.header1}>P 1, 499.00</Text>
          <Text style={[styles.descTxt, {color: colors.black}]}>
      ...
      <View name="Service3">
        ...
        <View style={[styles.container1, styles.secondary]}>
          <Text style={styles.header0}>Vaccine</Text>
          <Text style={styles.header1}>P 1, 499.00</Text>
          <Text style={[styles.descTxt, {color: colors.black}]}>
      ...
      <View name="Service4">
        ...
        <View style={[styles.container1, styles.secondary]}>
          <Text style={styles.header0}>Consultation</Text>
          <Text style={styles.header1}>P 1, 499.00</Text>
          <Text style={[styles.descTxt, {color: colors.black}]}>
      ...
      <View name="Service5">
        ...
        <View style={[styles.container1, styles.secondary]}>
          <Text style={styles.header0}>Laboratory</Text>
          <Text style={styles.header1}>P 1, 499.00</Text>
          <Text style={[styles.descTxt, {color: colors.black}]}>
      ...
      <View name="Service6">
        ...
        <View style={[styles.container1, styles.secondary]}>
          <Text style={styles.header0}>Dentistry</Text>
          <Text style={styles.header1}>P 1, 499.00</Text>
          <Text style={[styles.descTxt, {color: colors.black}]}>
      ...
      <View name="Service7">
        ...
        <View style={[styles.container1, styles.secondary]}>
          <Text style={styles.header0}>Radiology</Text>
          <Text style={styles.header1}>P 1, 499.00</Text>
          <Text style={[styles.descTxt, {color: colors.black}]}>
      ...
      <View name="Service8">
        ...
        <View style={[styles.container1, styles.secondary]}>
          <Text style={styles.header0}>Pharmacy</Text>
          <Text style={styles.header1}>P 1, 499.00</Text>
          <Text style={[styles.descTxt, {color: colors.black}]}>
      ...
      <View name="Service9">
        ...
        <View style={[styles.container1, styles.secondary]}>
          <Text style={styles.header0}>Pet Grooming</Text>
          <Text style={styles.header1}>P 1, 499.00</Text>
          <Text style={[styles.descTxt, {color: colors.black}]}>
